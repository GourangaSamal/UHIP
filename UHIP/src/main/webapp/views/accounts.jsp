			...
			<c:if test="${!empty listModel}">
				<c:forEach 
					...
					<tr>
						...
						<td>${get.gender}</td>
						<td>${get.userRole}</td>
						<td><a href="/loadUpdateForm/${get.userId}">Edit/Update</a></td>
						<td>
							<c:if test="${get.activeSwitch=='Y'}">
								<a href="/activateDeactivate/${get.userId}/${get.activeSwitch}" onclick="return deactConfirm()">De-Activate</a>
							</c:if>
							<c:if test="${get.activeSwitch=='N'}">
								<a href="/activateDeactivate/${get.userId}/${get.activeSwitch}" onclick="return actConfirm()">Activate</a>
							</c:if>
						</td>
					</tr>
